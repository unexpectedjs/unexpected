...
(typeof Map !== 'function' ? describe.skip : describe)('Map type', function () {
    ...
    it('should have values satisfying an object', function () {
        expect(function () {
            expect(new Map([[[], { foo: null }]]), 'to have values satisfying', { foo: expect.it('to be null') });
        }, 'not to error');
    });

    it('should output a diff when failing "to have values satisfying"', function () {
        expect(function () {
            expect(new Map([[[], { foo: null }]]), 'to have values satisfying', { foo: expect.it('to be a number') });
        }, 'to error',

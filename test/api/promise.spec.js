...
describe('expect.promise', () => {
  it('should forward non-unexpected errors', () => {
    var clonedExpect = expect
      .clone()
      .addAssertion('to foo', (expect, subject, value) => {
  ...
  it('should preserve the resolved value when an assertion contains a non-oathbreakable promise', done => {
    var clonedExpect = expect
      .clone()
      .addAssertion('to foo', (expect, subject, value) => {
    ...
    clonedExpect('foo', 'to foo').then(value => {

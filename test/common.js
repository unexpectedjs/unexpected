...
var fixpect = typeof require === 'function' ? require('fixpect') : function (expect) { return expect; };

expect = fixpect(unexpected.clone());

expectWithUnexpectedMagicPen = fixpect(unexpected.clone().use(typeof weknowhow === 'undefined' ?

...
describe("documentation tests", function () {
    ...
    it("assertions/Promise/to-be-fulfilled.md contains correct examples", function () {
        ...
        testPromises.push(expect.promise(function () {
            ...
            return expect.promise(function () {
                expect.fail(function (output) {
                    output.error("expected:").nl();
                    output.code("return expect(expect.promise.resolve('abc'), 'to be fulfilled with', 'def');").nl();
                    output.error("to throw");
                });
            });
        }).caught(function (e) {
    ...
    it("assertions/Promise/to-be-rejected.md contains correct examples", function () {
        ...
        testPromises.push(expect.promise(function () {
            ...
            return expect.promise(function () {
                expect.fail(function (output) {
                    output.error("expected:").nl();
                    output.code("var promiseThatWillBeRejectedWithAReason = expect.promise(function (resolve, reject) {").nl();
                    output.code("    setTimeout(function () {").nl();
                    output.code("        reject(new Error('Oh dear'));").nl();
                    output.code("    }, 10);").nl();
                    output.code("});").nl();
                    output.code("").nl();
    ...
    it("assertions/Promise/when-rejected.md contains correct examples", function () {
        ...
        testPromises.push(expect.promise(function () {
            ...
            return expect.promise(function () {
                expect.fail(function (output) {
                    output.error("expected:").nl();
                    output.code("return expect(expect.promise.resolve(123), 'when rejected', 'to have message', 'argh');").nl();
                    output.error("to throw");
                });
            });
        }).caught(function (e) {
    ...
    it("assertions/function/when-called.md contains correct examples", function () {
        var testPromises = [];
        function giveMeFive() {
            return 5;
        }
        ...
        try {
            ...
            expect.fail(function (output) {
                output.error("expected:").nl();
                output.code("expect(giveMeFive, 'when called', 'to equal', 7);").nl();
                output.error("to throw");
            });
        } catch (e) {
            expect(e, "to have message",
    ...
    it("assertions/object/to-be-empty.md contains correct examples", function () {
        var testPromises = [];
        expect({}, 'to be empty');
        ...
        try {
            ...
            expect.fail(function (output) {
                output.error("expected:").nl();
                output.code("expect({ a: 'a', b: 'b' }, 'to be empty');").nl();
                output.error("to throw");
            });
        } catch (e) {
            expect(e, "to have message",

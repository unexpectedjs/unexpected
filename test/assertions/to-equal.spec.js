  ...
  if (typeof Buffer !== 'undefined') {
    ...
    it('regression test for infinite loop in buffer diff code', () => {
      expect(function () {
        expect(
          Buffer.from([
            0x63, 0x74, 0x3d, 0x54, 0x3b, 0xd4, 0x8c, 0x3b, 0x66, 0x6f, 0x6f,
            0x3d, 0x62, 0x61, 0x72, 0x3b,
          ]),
          'to equal',
          Buffer.concat([
            Buffer.from('ct=T;;'),
        ...
        function () {
          expect(
            ...
            new Int8Array([
              0x00, 0x01, 0x02, 0x48, 0x65, 0x72, 0x65, 0x20, 0x69, 0x73, 0x20,
              0x74, 0x68, 0x65, 0x20, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x20, 0x49,
              0x20, 0x77, 0x61, 0x73, 0x20, 0x71, 0x75, 0x75, 0x78, 0x69, 0x6e,
              0x67, 0x20, 0x61, 0x62, 0x6f, 0x75, 0x74,
            ])
          );
        },
    ...
    it('produces a hex-diff in JSON when Uint32Arrays differ', () => {
      expect(
        function () {
          expect(
            new Uint32Array([
              0x00010248, 0x65726520, 0x69732074, 0x68652074, 0x68696e67,
              0x20492077, 0x61732074, 0x616c6b69, 0x6e672061, 0x626f7574,
            ]),
            'to equal',
            new Uint32Array([
              0x00010248, 0x65726520, 0x69732074, 0x68652074, 0x68696e67,
              0x20492077, 0x61732071, 0x75757869, 0x6e672061, 0x626f7574,
            ])
          );
        },
        'to throw',

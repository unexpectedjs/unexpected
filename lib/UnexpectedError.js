...
UnexpectedError.prototype.getDefaultErrorMessage = function (compact) {
    var message = this.expect.output.clone();
    if (this.assertion) {
        message.append(this.assertion.standardErrorMessage(compact));
    } else {
...
UnexpectedError.prototype.getNestedErrorMessage = function (compact) {
    ...
    var parentCompact =
        this.assertion && parent.assertion &&
...
UnexpectedError.prototype.getErrorMessage = function (compact) {
    ...
    switch (errorMode) {
    case 'nested': return this.getNestedErrorMessage(compact);
    case 'default': return this.getDefaultErrorMessage(compact);
    case 'bubble': return this.parent.getErrorMessage(compact);

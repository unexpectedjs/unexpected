...
expectPrototype._executeExpect = function(
  ...
  // FIXME: 'assertionRule &&' can be removed because it's checked above
  if (assertionRule && assertionRule.expect && assertionRule.expect !== this) {
    return assertionRule.expect(subject, testDescriptionString, ...args);
  }

  // FIXME: Move into _createWrappedExpect?
...
// FIXME: The methods should probably throw if called on the top-level expect

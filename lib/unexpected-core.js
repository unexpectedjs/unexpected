...
(function () {
    ...
    var defaultOutputFormat = namespace.defaultFormat();
    if (defaultOutputFormat === 'html') { // Disable html format for now
    ...
    function Unexpected(options) {
        ...
        this._outputFormat = options.format || defaultOutputFormat;
    }
    ...
    Unexpected.prototype.inspect = function (obj, depth) {
        ...
        return printOutput(this.output.clone(), obj, depth || 3).toString(outputFormat);
    };

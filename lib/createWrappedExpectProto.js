...
module.exports = function createWrappedExpectProto(executionContext) {
    ...
    var wrappedExpectProto = {
        ...
        getType: expect.getType,
        output: expect.output,
        outputFormat: expect.outputFormat,
        format: expect.format,
        it: expect.it.bind(expect),
        promise: makePromise,
    ...
    if (utils.canSetPrototype) {
        utils.setPrototypeOf(wrappedExpectProto, Function.prototype);
    }

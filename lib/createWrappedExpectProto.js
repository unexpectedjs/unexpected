...
function findSuffixAssertions(assertionString, unexpected) {
  ...
  const straightforwardAssertions = lookupAssertionsInParentChain(assertionString, unexpected);
      ...
      if (!this._assertionIndices) {
        ...
        OUTER: while (true) {
          if (
            ...
            isAssertionArg(currentAssertionRule.args[currentAssertionRule.args.length - 2])
          ) {

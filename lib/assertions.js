...
module.exports = function (expect) {
    ...
    if (typeof Buffer !== 'undefined') {
        expect.addAssertion('Buffer', 'when decoded as', function (expect, subject, value) {
            return this.shift(expect, subject.toString(value), 1);
        });
    }
    ...
    expect.addAssertion('array', 'when passed as parameters to [async]', function (expect, subject, fn) { // ...
        this.errorMode = 'nested';
        if (this.flags.async) {
            var that = this;
            return expect.promise(function (run) {
                var args = subject.concat(run(function (err, result) {

            ...
            keyPromises[i] = expect.promise(function () {
                ...
                if (valueKeyType.is('function')) {
                    if (typeof subject[i] === 'function') {
                        subject[i] = subject[i].bind(subject);
                    }
                    return value[i].call(subject, typeof subject[i] === 'function' ? subject[i].bind(subject) : subject[i]);
                } else {
    ...
    expect.addAssertion('<object> to [exhaustively] satisfy <object>', function (expect, subject, value) {
        ...
        keys.forEach(function (key, index) {
            promiseByKey[key] = expect.promise(function () {
                ...
                if (valueKeyType.is('function')) {
                    return value[key].call(subject, typeof subject[key] === 'function' ? subject[key].bind(subject) : subject[key]);
                } else {

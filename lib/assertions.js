...
module.exports = function (expect) {
    ...
    if (typeof Buffer !== 'undefined') {
        expect.addAssertion('<Buffer> when decoded as <string> <any+>', function (expect, subject, value) {
    ...
    expect.addAssertion('<any> to [exhaustively] satisfy assertion <string> <any*>', function (expect, subject) {
        expect.errorMode = 'bubble'; // to satisfy assertion 'to be a number' => to be a number
    ...
    expect.addAssertion('<function> when called with <array-like> <string> <any*>', function (expect, subject, args) { // ...
        expect.errorMode = 'nested';
    ...
    expect.addAssertion([
        '<array-like> when passed as parameters to [async] <function> <string> <any*>',
        '<array-like> when passed as parameters to [constructor] <function> <string> <any*>'
    ...
    expect.addAssertion([
        '<any> when passed as parameter to [async] <function> <string> <any*>',
        '<any> when passed as parameter to [constructor] <function> <string> <any*>'
    ], function (expect, subject, fn) { // ...
        expect.errorMode = 'nested';
        var args = [subject];
        if (expect.flags.async) {

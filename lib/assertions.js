...
module.exports = function (expect) {
    ...
    expect.addAssertion(['object', 'array'], '[not] to have [own] property', function (expect, subject, key, value) {
    ...
    expect.addAssertion(['string', 'array', 'object'], '[not] to have length', function (expect, subject, length) {
    ...
    expect.addAssertion(['string', 'array', 'object'], '[not] to be empty', function (expect, subject) {
        var length;
    ...
    expect.addAssertion(['string', 'array', 'object'], 'to be non-empty', function (expect, subject) {
        expect(subject, 'not to be empty');
    });
    ...
    expect.addAssertion(['string', 'array'], '[not] to contain', function (expect, subject, arg) {
    ...
    expect.addAssertion(['object', 'array'], 'to be (a|an) [non-empty] (map|hash|object) whose values satisfy', function (expect, subject) {
    ...
    forEach(['string', 'number', 'boolean', 'array', 'object', 'function', 'regexp', 'regex', 'regular expression'], function (type) {
        expect.addAssertion('array', 'to be (a|an) [non-empty] array of ' + type + (type === 'regex' ? 'es' : 's'), function (expect, subject) {

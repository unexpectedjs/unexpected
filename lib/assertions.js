...
module.exports = function (expect) {
    ...
    expect.addAssertion('function', 'when called with', function (expect, subject, args) { // ...
        expect.apply(expect, [subject.apply(subject, args)].concat(Array.prototype.slice.call(arguments, 3)));
    });

    expect.addAssertion('array', 'when passed as parameters to', function (expect, subject, fn) { // ...
        expect.apply(expect, [fn.apply(fn, subject)].concat(Array.prototype.slice.call(arguments, 3)));
    });
};

...
module.exports = function(expect) {
  ...
  expect.addAssertion("<number> [not] to be close to <number> <number?>", function(
    expect,
    subject,
    value,
    epsilon
  ...
  expect.addAssertion("<any> [not] to be (a|an) <function>", function(
    expect,
    subject,
    Constructor
  ) {
  ...
  expect.addAssertion("<string> to be (the empty|an empty|a non-empty) string", function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion("<array-like> to be (the empty|an empty|a non-empty) array", function(
    expect,
    subject
  ) {
    expect(subject, expect.alternations[0] === "a non-empty" ? "not to be empty" : "to be empty");
  ...
  expect.addAssertion("<object|function> [not] to have own property <string>", function(
    expect,
    subject,
    key
  ) {
  ...
  expect.addAssertion("<object|function> [not] to have property <string>", function(
    expect,
    subject,
    key
  ) {
  ...
  expect.addAssertion("<object|function> to have [own] property <string> <any>", function(
    expect,
    subject,
    key,
  ...
  expect.addAssertion("<object|function> [not] to have [own] properties <array>", function(
    expect,
    subject,
    propertyNames
  ) {
  ...
  expect.addAssertion("<object|function> to have [own] properties <object>", function(
    expect,
    subject,
    properties
  ) {
  ...
  expect.addAssertion("<string|array-like> [not] to have length <number>", function(
    expect,
    subject,
    length
  ) {
  ...
  expect.addAssertion("<object> to [not] [only] have keys <array>", function(
    expect,
    subject,
    keys
  ) {
  ...
  expect.addAssertion("<object> to [not] [only] have key <string>", function(
    expect,
    subject,
    value
  ) {
    ...
    expect.withError(
      function() {
        args.forEach(function(arg) {
          expect(
            subject &&
              Array.prototype.some.call(subject, function(item) {
        ...
        expect.fail({
          diff:
            ...
            function(output, diff, inspect, equal) {
              return diff(
                subject,
                Array.prototype.filter.call(subject, function(item) {
  ...
  expect.addAssertion("<number> [not] to be within <number> <number>", function(
    expect,
    subject,
    start,
    finish
  ...
  expect.addAssertion("<string> [not] to be within <string> <string>", function(
    expect,
    subject,
    start,
    finish
  ...
  expect.addAssertion("<number> [not] to be (less than|below) <number>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<string> [not] to be (less than|below) <string>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<number> [not] to be less than or equal to <number>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<string> [not] to be less than or equal to <string>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<number> [not] to be (greater than|above) <number>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<string> [not] to be (greater than|above) <string>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<number> [not] to be greater than or equal to <number>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<string> [not] to be greater than or equal to <string>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<function> to (throw|throw error|throw exception)", function(
    expect,
    subject
  ) {
    try {
  ...
  expect.addAssertion("<function> to (throw|throw error|throw exception) <any>", function(
    expect,
    subject,
    arg
  ) {
  ...
  expect.addAssertion("<Error> to [exhaustively] satisfy <Error>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<Error> to [exhaustively] satisfy <object>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<Error> to [exhaustively] satisfy <regexp|string>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<binaryArray> to [exhaustively] satisfy <expect.it>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<UnexpectedError> to [exhaustively] satisfy <function>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<any|Error> to [exhaustively] satisfy <function>", function(
    expect,
    subject,
    value
  ) {
  ...
  if (typeof Buffer !== "undefined") {
    expect.addAssertion("<Buffer> [when] decoded as <string> <assertion?>", function(
      expect,
      subject,
      value
    ) {
  ...
  expect.addAssertion("<any> not to [exhaustively] satisfy [assertion] <any>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<any> to [exhaustively] satisfy assertion <any>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<any> to [exhaustively] satisfy assertion <assertion>", function(
    expect,
    subject
  ) {
    expect.errorMode = "bubble"; // to satisfy assertion 'to be a number' => to be a number
  ...
  expect.addAssertion("<any> to [exhaustively] satisfy [assertion] <expect.it>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<regexp> to [exhaustively] satisfy <regexp>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<string> to [exhaustively] satisfy <regexp>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<function> to [exhaustively] satisfy <function>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<binaryArray> to [exhaustively] satisfy <binaryArray>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<array-like> to [exhaustively] satisfy <array-like>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<object> to [exhaustively] satisfy <object>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<wrapperObject> to [exhaustively] satisfy <wrapperObject>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<wrapperObject> to [exhaustively] satisfy <any>", function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion("<function> [when] called with <array-like> <assertion?>", function(
    expect,
    subject,
    args
  ) {
  ...
  expect.addAssertion("<Promise> when rejected <assertion>", function(
    expect,
    subject,
    nextAssertion
  ) {
  ...
  expect.addAssertion("<Promise> when fulfilled <assertion>", function(
    expect,
    subject,
    nextAssertion
  ) {
  ...
  expect.addAssertion("<function> to call the callback with error <any>", function(
    expect,
    subject,
    value
  ) {

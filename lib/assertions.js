...
module.exports = function (expect) {
    ...
    expect.addAssertion('function', 'when called with', function (expect, subject, args) { // ...
        expect.apply(expect, [new FunctionInvocation(subject, args)].concat(Array.prototype.slice.call(arguments, 3)));
    });

    expect.addAssertion('array', 'when passed as parameters to', function (expect, subject, fn) { // ...
        expect.apply(expect, [new FunctionInvocation(fn, subject)].concat(Array.prototype.slice.call(arguments, 3)));
    });

    expect.addAssertion('functionInvocation', 'to return result satisfying', function (expect, subject) {
        expect.apply(expect, [subject.fn.apply(subject, subject.args), 'to satisfy assertion'].concat(Array.prototype.slice.call(arguments, 2)));
    });
};

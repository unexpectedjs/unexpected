...
module.exports = function(expect) {
  expect.addAssertion('<any> [not] to be (ok|truthy)', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<any> [not] to be (ok|truthy) <string>', function(
    expect,
    subject,
    message
  ) {
  ...
  expect.addAssertion('<any> [not] to be <any>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<string> [not] to be <string>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<any> [not] to be falsy <string>', function(
    expect,
    subject,
    message
  ) {
  ...
  expect.addAssertion('<number|NaN> [not] to be NaN', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<any> [not] to be (a|an) <type>', function(
    expect,
    subject,
    type
  ) {
  ...
  expect.addAssertion('<any> [not] to be (a|an) <string>', function(
    expect,
    subject,
    typeName
  ) {
  ...
  expect.addAssertion('<any> [not] to be one of <array>', function(
    expect,
    subject,
    superset
  ) {
  ...
  expect.addAssertion('<any> [not] to be an (object|array)', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<string> to match <regexp>', function(
    expect,
    subject,
    regexp
  ) {
  ...
  expect.addAssertion('<string> not to match <regexp>', function(
    expect,
    subject,
    regexp
  ) {
      ...
      function(e) {
        expect.fail({
          ...
          diff: function(output) {
            ...
            subject.replace(new RegExp(regexp.source, 'g'), function(
              $0,
              index
            ) {
  ...
  expect.addAssertion(
    ...
    function(expect, subject, key, expectedPropertyValue) {
      return expect(subject, 'to have [own] property', key).then(function(
        actualPropertyValue
      ) {
  ...
  expect.addAssertion('<string|array-like> [not] to be empty', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<string|array-like|object> to be non-empty', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<object> not to have keys <array>', function(
    expect,
    subject,
    keys
  ) {
  ...
  expect.addAssertion('<object> not to have key <string>', function(
    expect,
    subject,
    value
  ) {
            ...
            if (expect.flags.not) {
              ...
              ranges
                ...
                .forEach(function(range) {
                  ...
                  var firstUncoveredIndex = Math.max(
                    range.startIndex,
                    lastIndex
                  );
                  if (range.endIndex > firstUncoveredIndex) {
                    if (range.partial) {
                      output.partialMatch(
                        subject.substring(firstUncoveredIndex, range.endIndex)
                      );
                    } else {
                      output.match(
                        subject.substring(firstUncoveredIndex, range.endIndex)
  ...
  expect.addAssertion('<string> [not] to begin with <string>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<string> [not] to end with <string>', function(
    expect,
    subject,
    value
  ) {
        ...
        expect.fail({
          diff: function(output) {
            ...
            if (expect.flags.not) {
              ...
              var i = 0;
              while (
                subject[subject.length - 1 - i] === value[value.length - 1 - i]
              ) {
                i += 1;
              }
              if (i === 0) {
  ...
  expect.addAssertion('<number> [not] to be infinite', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<number> [not] to be positive', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<number> [not] to be negative', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<any> not to equal <any>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<function> to error [with] <any>', function(
    expect,
    subject,
    arg
  ) {
  ...
  expect.addAssertion('<function> to throw (a|an) <function>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<function> to have arity <number>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<Error> to have message <any>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<Error> to [exhaustively] satisfy <any>', function(
    expect,
    subject,
    value
  ) {
  ...
  expect.addAssertion('<any> to [exhaustively] satisfy <any>', function(
    expect,
    subject,
    value
  ) {
          ...
          return expect.promise.settle(keyPromises).then(function() {
            ...
            function failWithChanges(changes) {
              ...
              expect.fail({
                diff: function(output, diff, inspect, equal) {
                  output.inline = true;
                  var indexOfLastNonInsert = changes.reduce(function(
                    previousValue,
                    diffItem,
                    index
                  ) {
                              ...
                              output.clone().block(function() {
                                if (type === 'remove') {
                                  ...
                                  if (valueDiff && valueDiff.inline) {
                                    this.append(
                                      valueDiff.amend(delimiterOutput)
                                    );
                                  } else {
                                    this.append(
                                      inspect(diffItem.value).amend(
      ...
      .all([
        expect.promise(function() {
          if (expect.flags.exhaustively) {
            ...
            var subjectKeysWithDefinedValues = subjectKeys.filter(function(
              key
            ) {
  ...
  expect.addAssertion('<function> [when] called <assertion?>', function(
    expect,
    subject
  ) {
    expect.errorMode = 'nested';
  ...
  expect.addAssertion('<function> when rejected <assertion>', function(
    expect,
    subject,
    ...rest
  ) {
  ...
  expect.addAssertion('<function> when fulfilled <assertion>', function(
    expect,
    subject,
    ...rest
  ) {
  ...
  expect.addAssertion('<function> to call the callback', function(
    expect,
    subject
  ) {
    expect.errorMode = 'nested';
  ...
  expect.addAssertion('<function> to call the callback without error', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion('<function> to call the callback with error', function(
    expect,
    subject
  ) {
  ...
  expect.addAssertion(
    ...
    function(expect, subject, value) {
      return expect(subject, 'to call the callback with error').tap(function(
        err
      ) {
        expect.errorMode = 'nested';
        if (

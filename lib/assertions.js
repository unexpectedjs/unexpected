...
module.exports = function (expect) {
    ...
    expect.addAssertion([
        ...
        '<Promise> to be fulfilled with a value [exhaustively] satisfying <any>'
    ], function (expect, subject, value) {
        expect.errorMode = 'nested';
    ...
    expect.addAssertion([
        ...
        '<function> to be fulfilled with a value [exhaustively] satisfying <any>'
    ], function (expect, subject, value) {
        expect.errorMode = 'nested';
        return expect(expect.promise(function () {
            return subject();
        }), 'to be fulfilled with a value [exhaustively] satisfying', value);
    });

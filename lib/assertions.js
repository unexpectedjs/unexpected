...
module.exports = function (expect) {
    ...
    expect.addAssertion('function', [
        'to call the (callback|callback without error|callback with error)'
    ], function (expect, subject, expectedError) {
        var alternation = this.alternations[0];
        if (alternation === 'callback without error' && typeof expectedError !== 'undefined') {
        ...
        return expect.promise(function (run) {
            subject(run(function (err) {
                if (alternation !== 'callback') {
                    if (alternation === 'callback without error') {
                        if (err) {

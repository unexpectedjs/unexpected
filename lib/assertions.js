...
module.exports = function (expect) {
    ...
    expect.addAssertion('to satisfy [assertion]', function (expect, subject, value) {
        if (this.flags.assertion && typeof value === 'string') {
            ...
            forEach(getKeys(value), function (key) {
                expect(subject[key], 'to satisfy', value[key]);
            });
        } else {

...
module.exports = function (expect) {
    ...
    expect.addAssertion('<any> to [exhaustively] satisfy <regexp>', function (expect, subject, value) {
    ...
    expect.addAssertion('<any> to [exhaustively] satisfy <array-like|object>', function (expect, subject, value) {

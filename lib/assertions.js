...
module.exports = function (expect) {
    ...
    // NOTE (v10): Could be split up further, but would be verbose
    // ... except if we changed 'to error' so it provides the error instance as the fulfillment value.
    ...
    // NOTE (v10): Could be split up further, but would be verbose
    // ... except if we changed 'to throw' so it provides the error instance as the fulfillment value.
    ...
    // NOTE (v10): Could exist in more specific variants, but would be verbose:
    ...
    // NOTE (v10): Could be split up further, but would be verbose:
    expect.addAssertion('<function> to call the callback (|without error|with error) <any?>', function (expect, subject, expectedError) {

...
module.exports = function (expect) {
    ...
    expect.addAssertion('string', '[not] to begin with', function (expect, subject, cmp) {
        var stringCmp = String(cmp);

        expect(subject.substr(0, stringCmp.length), '[not] to be', stringCmp);
    });

    expect.addAssertion('string', '[not] to end with', function (expect, subject, cmp) {
        var stringCmp = String(cmp);

        expect(subject.substr(-stringCmp.length), '[not] to be', stringCmp);
    });

...
Unexpected.prototype.fail = function (args) {
    var arg = args[0];
    ...
    if (typeof arg === 'function') {
        ...
        var placeHolderArgs = Array.prototype.slice.call(args, 1);
        ...
        if (assertionRule) {
            ...
            var wrappedExpect = function wrappedExpect() {
                ...
                callInNestedContext(function () {
                    executeExpect(subject, testDescriptionString, args);
                });
            };

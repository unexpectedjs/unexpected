...
function Unexpected(options) {
  ...
  this.getType = function(typeName) {
    return (
      that.typeByName[typeName] ||
      (that.parent && that.parent.getType(typeName))
    );
  };
  this.findTypeOf = function(obj) {
    return (
      utils.findFirst(that.types || [], function(type) {
...
Unexpected.prototype.equal = function(actual, expected, depth, seen) {
  ...
  return this.findCommonType(actual, expected).equal(actual, expected, function(
    a,
    b
  ) {
...
Unexpected.prototype.parseAssertion = function(assertionString) {
  ...
  var assertionRequirements = lastArgRequirements.filter(function(
    argRequirement
  ) {
    return argRequirement.type.is('assertion');
  });
    ...
    assertionDeclarations.forEach(function(assertionDeclaration) {
      ...
      expandedAssertions.forEach(function(expandedAssertion) {
        ...
        maxNumberOfArgs = Math.max(
          maxNumberOfArgs,
          assertionDeclaration.args.reduce(function(previous, argDefinition) {
            return (
              previous +
...
Unexpected.prototype.use = function(plugin) {
  ...
  var existingPlugin = utils.findFirst(this.installedPlugins, function(
    installedPlugin
  ) {
    ...
    this.fail({
      message: function(output) {
        ...
        var assertionDeclarations = Object.keys(
          candidateHandlers.reduce(function(result, handler) {

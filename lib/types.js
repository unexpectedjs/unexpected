...
module.exports = function (expect) {
    ...
    expect.addType({
        ...
        inspect: function (obj, depth, output, inspect) {
            ...
            var type = this;
            var hasKeyOverride = typeof type.valueFromKey === 'function';
    ...
    expect.addType({
        ...
        uniqueKeys: utils.uniqueKeysAndSymbols,
    ...
    expect.addType({
        ...
        diff: function (actual, expected, output, diff, inspect, equal) {
            ...
            var nonNumericalKeysAndSymbols = !this.numericalPropertiesOnly

...
module.exports = function (expect) {
    expect.addType({
        ...
        diff: function (actual, expected, output, diff, inspect, equal) {
            if (actual.constructor !== expected.constructor) {
                return {
                    diff: output.text('Mismatching prototypes ')
    ...
    expect.addType({
        ...
        identify: function (value) {
            return utils.isArguments(value);
        },
        equal: function (a, b, equal) {
            return a === b ||
                equal(Array.prototype.slice.call(a), Array.prototype.slice.call(b));
        },
        inspect: function (args, depth, output, inspect) {
            return inspect(Array.prototype.slice.call(args));
        },
        diff: function (actual, expected, output, diff) {
            return diff(Array.prototype.slice.call(actual), Array.prototype.slice.call(expected));
        }
    });

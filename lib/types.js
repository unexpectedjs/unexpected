...
module.exports = function (expect) {
    ...
    expect.addType({
        ...
        identify: function (value) {
            return value && value.type && value.type._unexpectedType &&
                typeof value.minimum === 'number' &&
                typeof value.maximum === 'number';
        },
        inspect: function (value, depth, output) {
            output.jsKeyword('<').jsKeyword(value.type.name);
            ...
            } else if (value.minimum === 1 && value.maximum === Infinity) {
                output.jsKeyword('*');
            }

            return output.jsKeyword('>');
        }
    });

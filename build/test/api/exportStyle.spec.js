...
describe('styleType', function () {
    ...
    it('is chainable', function () {
        childExpect.exportStyle('firstStyle', function () {}).exportStyle('secondStyle', function () {});
    ...
    it('makes the style available to the parent expect', function () {
        ...
        expect(parentExpect.createOutput().fancyQuotes('yadda').toString(), 'to equal', '>>yadda<<');
    });
    ...
    it('does not make the style available to a parent parent expect', function () {
        ...
        expect(parentExpect.createOutput(), 'to satisfy', { fancyQuotes: undefined });
    });
    ...
    it('binds the style handler to a child expect output so custom types are available inside the exported style', function () {
        ...
        expect(parentExpect.createOutput().emphasize('yadda').toString(), 'to equal', '>>yadda<<');
    });
});
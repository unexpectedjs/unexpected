...
describe('clone', function () {
    ...
    it('changes to the clone does not affect the original instance', function () {
        expect(expect.assertions, 'not to have keys', 'to be the answer to the Ultimate Question of Life, the Universe, and Everything', 'not to be the answer to the Ultimate Question of Life, the Universe, and Everything');
    });
    ...
    describe('when the assertion does not exist', function () {
        ...
        describe('but exists for another type', function () {
            it('explains that in the error message', function () {
                ...
                expect(function () {
                    clonedExpect('foobarquux', 'to foobarquux');
                }, 'to throw', "expected 'foobarquux' to foobarquux\n" + "  The assertion does not have a matching signature for:\n" + "    <string> to foobarquux\n" + "  did you mean:\n" + "    <array> to foobarquux");
            });
            ...
            it('prefers to suggest a similarly named assertion defined for the correct type over an exact match defined for other types', function () {
                ...
                }, 'to throw', "expected [ 'fooo' ] to fooo\n" + "  The assertion does not have a matching signature for:\n" + "    <array> to fooo\n" + "  did you mean:\n" + "    <string> to fooo");
            ...
            it('prefers to suggest a similarly named assertion for a more specific type', function () {
                ...
                }).addAssertion('<myType> to fooa', function () {}).addAssertion('<myMoreSpecificType> to foob', function () {}).addAssertion('<myMostSpecificType> to fooc', function () {});

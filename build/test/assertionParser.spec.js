...
describe('parseAssertion', function () {
    ...
    it('converts an assertion string to an object representation', function () {
        ...
        expect(assertion, 'to satisfy', [{
            ...
            assertion: '[not] to be',
            args: [{ minimum: 1, maximum: 1, type: { name: 'string' } }, { minimum: 0, maximum: Infinity, type: { name: 'string' } }]
        }, {
            subject: { minimum: 1, maximum: 1, type: { name: 'string' } },
            assertion: '[not] to be',
            args: [{ minimum: 1, maximum: 1, type: { name: 'string' } }, { minimum: 1, maximum: 1, type: { name: 'object' } }]
        }, {
    ...
    describe('with an assertion that has <assertion>', function () {
        it('should accept it as the last argument', function () {
            ...
            expect(assertion, 'to satisfy', [{
                ...
                args: [{ type: { name: 'string' }, minimum: 1, maximum: 1 }, { type: { name: 'assertion' }, minimum: 1, maximum: 1 }, { type: { name: 'any' }, minimum: 0, maximum: Infinity }]
            }, {
                subject: { type: { name: 'Buffer' }, minimum: 1, maximum: 1 },
                assertion: 'when decoded as',
                args: [{ type: { name: 'string' }, minimum: 1, maximum: 1 }, { type: { name: 'expect.it' }, minimum: 1, maximum: 1 }]
            }]);
        });

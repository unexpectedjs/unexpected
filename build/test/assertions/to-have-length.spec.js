...
describe('to have length assertion', function () {
    ...
    it('throws when the assertion fails', function () {
        ...
        }, 'to throw exception', "expected { length: 4 } to have length 4\n" + "  The assertion does not have a matching signature for:\n" + "    <object> to have length <number>\n" + "  did you mean:\n" + "    <string|array-like> [not] to have length <number>");
    });

    if (typeof Buffer !== 'undefined') {
        it('asserts Buffer .length', function () {
    ...
    if (typeof Uint8Array !== 'undefined') {
        it('asserts length for Uint8Array', function () {
            expect(new Uint8Array([0x45, 0x59]), 'to have length', 2);
        });
    }

    if (typeof Uint16Array !== 'undefined') {
        it('asserts length for Uint16Array', function () {

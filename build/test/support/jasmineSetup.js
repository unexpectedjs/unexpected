...
var shouldApplyPatch = typeof jasmine !== 'undefined' && typeof jasmine.version === 'string' && jasmine.version.match(/^2\./);
...
if (typeof it === 'function' && shouldApplyPatch) {
    ...
    it = function it(title, fn) {
        ...
        var wrapper = function wrapper(done) {
            var result;
            try {
                if (async) {
                ...
                var isPromise = result && (typeof result === 'undefined' ? 'undefined' : _typeof(result)) === 'object' && typeof result.then === 'function';

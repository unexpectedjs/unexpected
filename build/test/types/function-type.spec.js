...
describe('function type', function () {
    ...
    var isNodeJs3OrBelow = (typeof process === 'undefined' ? 'undefined' : _typeof(process)) === 'object' && /^v[0123]\./.test(process.version);
    ...
    if (!isNodeJs3OrBelow && !isPhantomJs) {
        ...
        it('should inspect an anonymous bound function correctly', function () {
            expect(function () {}.bind({}), 'to inspect as', 'function bound () { /* native code */ }');
        });

        it('should inspect a named bound function correctly', function () {
            expect(function foo() {}.bind({}), 'to inspect as', 'function bound foo() { /* native code */ }');
        });
    }
    ...
    try {
        implicitReturnMultilineArrowFunction = new Function('return a => \n    a + 1;')();
    } catch (e) {}
    ...
    try {
        evilImplicitReturnMultilineArrowFunction = new Function('return a => \n    a || {};')();
    } catch (e) {}

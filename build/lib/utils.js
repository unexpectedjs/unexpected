...
var utils = module.exports = {
    ...
    isError: function isError(err) {
        return (typeof err === 'undefined' ? 'undefined' : _typeof(err)) === 'object' && (Object.prototype.toString.call(err) === '[object Error]' || err instanceof Error);
    },
    ...
    uniqueNonNumericalStringsAndSymbols: function uniqueNonNumericalStringsAndSymbols() {
        ...
        return utils.uniqueStringsAndSymbols(function (stringOrSymbol) {
            return (typeof stringOrSymbol === 'undefined' ? 'undefined' : _typeof(stringOrSymbol)) === 'symbol' || !utils.numericalRegExp.test(stringOrSymbol);

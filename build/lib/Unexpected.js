...
function createExpectIt(unexpected, expectations) {
    ...
    function expectIt(subject, context) {
        context = context && (typeof context === 'undefined' ? 'undefined' : _typeof(context)) === 'object' && context instanceof Context ? context : new Context(unexpected);
...
Unexpected.prototype.addAssertion = function (patternOrPatterns, handler, childUnexpected) {
    var maxArguments;
    if ((typeof childUnexpected === 'undefined' ? 'undefined' : _typeof(childUnexpected)) === 'object') {
        maxArguments = 3;
    } else {
        maxArguments = 2;
    }
...
Unexpected.prototype.use = function (plugin) {
    if (typeof plugin !== 'function' && ((typeof plugin === 'undefined' ? 'undefined' : _typeof(plugin)) !== 'object' || typeof plugin.installInto !== 'function') || typeof plugin.name !== 'undefined' && typeof plugin.name !== 'string') {

...
module.exports = function (expect) {
    ...
    if (typeof Symbol === 'function') {
        ...
        keyComparator = function keyComparator(a, b) {
            ...
            var aString = a;
            var bString = b;
            aIsSymbol = (typeof a === 'undefined' ? 'undefined' : _typeof(a)) === 'symbol';
            bIsSymbol = (typeof b === 'undefined' ? 'undefined' : _typeof(b)) === 'symbol';
            if (aIsSymbol) {
                if (bIsSymbol) {
                    aString = a.toString();
                    bString = b.toString();
    ...
    expect.addType({
        ...
        identify: function identify(value) {
            return value && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && value._isUnexpected && this.baseType.identify(value);
        },
        getKeys: function getKeys(value) {
